...
FULLY_EVOLVED_OBTAINABLE_POKEMON: list[int] = [
    ...
    362, 365, 366, 369, 370, 398, 400, 402, 405, 407, 409, 411, 414,
    416, 417, 419, 421, 423, 424, 426, 428, 429, 430, 432, 435, 437, 441, 442,
    448, 450, 452, 454, 455, 457, 460, 461, 462, 463, 465, 468, 469, 470,
...
if __name__ == "__main__":
    ...
    pprint.pp(pokemon_to_index.keys())
